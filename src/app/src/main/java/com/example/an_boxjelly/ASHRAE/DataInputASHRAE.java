...
public class DataInputASHRAE extends BaseActivity {
    ...
    public void castToFloat (){
        ...
        rpin = Float.parseFloat(mEtRpin.getText().toString());
        //Outer Radius of U loop. Suggested value 0.0167.
        rpext = Float.parseFloat(mEtRpext.getText().toString());
        //Radius of Borehole. Suggested value 0.054.
        rbore = Float.parseFloat(mEtRbore.getText().toString());
        //Ground Thermal Conductivity. Suggested value 1.73 for Melbourne.
        kG = Float.parseFloat(mEtKG.getText().toString());
        //groundThermalConductivity
        kgrout = Float.parseFloat(mEtKgrout.getText().toString());
        //pipeThermalConductivity. Suggested value 0.346.
        kpipe = Float.parseFloat(mEtKpipe.getText().toString());
        //centreDistanceBetweenPipes
        Lu = Float.parseFloat(mEtLu.getText().toString());
        //Internal Convection Coefficient. Suggested value 1000.
        hconv = Float.parseFloat(mEtHconv.getText().toString());
        //groundThermalDiffusivity
        alpha = Float.parseFloat(mEtAlpha.getText().toString());
        //enteringWaterTemp
        Tin = Float.parseFloat(mEtTin.getText().toString());
        //massFlowRate
        mfls = Float.parseFloat(mEtMfls.getText().toString());
        //specificHeatCapacity
        Cp = Float.parseFloat(mEtCp.getText().toString());
        // distanceBetweenBoreholes
        B = Float.parseFloat(mEtB.getText().toString());
        // the borehole depth in IOS line 58 is = distanceBetweenBoreholes/distanceDepthRatio
        // distanceDepthRation = 0.05
        H = Float.parseFloat(mEtH.getText().toString());
        //numberOfBoreholes
        ...
        qy = Float.parseFloat(mEtQy.getText().toString());
        qh = Float.parseFloat(mEtQh.getText().toString());
        Tg = Float.parseFloat(mEtTg.getText().toString());
        qmc = Float.parseFloat(mEtQmc.getText().toString());
    }
    ...
    public double calculateASHRAE (){
        ...
        dimensionlessTime = Math.log(3650/(Math.pow(boreholeDepth,2)/(9*alpha)));// Ln(t/ts)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ashrae_data_input);
    ...
    public void setAutoFillConfig(){
        addAutoFillConfig(mEtCp,getString(R.string.DataInputASHRAE_mEtCp));
        addAutoFillConfig(mEtTin,getString(R.string.DataInputASHRAE_mEtTin));
        addAutoFillConfig(mEtMfls,getString(R.string.DataInputASHRAE_mEtMfls));
        addAutoFillConfig(mEtAlpha,getString(R.string.DataInputASHRAE_mEtAlpha));
        addAutoFillConfig(mEtKG,getString(R.string.DataInputASHRAE_mEtKG));
        addAutoFillConfig(mEtTg,getString(R.string.DataInputASHRAE_mEtTg));
        addAutoFillConfig(mEtQy,getString(R.string.DataInputASHRAE_mEtQy));
        addAutoFillConfig(mEtQmc,getString(R.string.DataInputASHRAE_mEtQmc));
        addAutoFillConfig(mEtQh,getString(R.string.DataInputASHRAE_mEtQh));
        addAutoFillConfig(mEtB,getString(R.string.DataInputASHRAE_mEtB));
        addAutoFillConfig(mEtNumberOfBoreholes,getString(R.string.DataInputASHRAE_mEtNumberOfBoreholes));
        addAutoFillConfig(mEtA,getString(R.string.DataInputASHRAE_mEtA));
        addAutoFillConfig(mEtH,getString(R.string.DataInputASHRAE_mEtH));
        addAutoFillConfig(mEtRbore,getString(R.string.DataInputASHRAE_mEtRbore));
        addAutoFillConfig(mEtKgrout,getString(R.string.DataInputASHRAE_mEtKgrout));
        addAutoFillConfig(mEtLu,getString(R.string.DataInputASHRAE_mEtLu));
        addAutoFillConfig(mEtRpin,getString(R.string.DataInputASHRAE_mEtRpin));
        addAutoFillConfig(mEtRpext,getString(R.string.DataInputASHRAE_mEtRpext));
        addAutoFillConfig(mEtKpipe,getString(R.string.DataInputASHRAE_mEtKpipe));
        addAutoFillConfig(mEtHconv,getString(R.string.DataInputASHRAE_mEtHconv));
    }
    ...
    if (isValid) {
        ...
        Toast.makeText(DataInputASHRAE.this, "You entered an invalid input!", Toast.LENGTH_SHORT).show();
    }
}
}
